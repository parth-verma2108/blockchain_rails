...
module Authenticated::Lender::Api
  class SetupController < Authenticated::LenderController
    def update
      ...
      ActiveRecord::Base.transaction do
        ...
        lending_parameter = current_user.create_lending_parameter unless current_user.lending_parameter

        current_user.profile.update!(profile_params)
        current_user.lending_parameter.update!(lending_parameter_params)
